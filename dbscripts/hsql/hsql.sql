...
INSERT INTO RECURSOS(RECURSO) VALUES('/maestros/_masterentity/Suscriptor');
INSERT INTO RECURSOS(RECURSO) VALUES('/maestros/dispositivos/_masterentity/Gateway');
INSERT INTO RECURSOS(RECURSO) VALUES('/maestros/dispositivos/_masterentity/Medidor');

INSERT INTO ROLES(NOMBRE_ROL,DESCRIPCION_ROL) VALUES('SUPERADMIN','ROL RESERVADO POR LA APICACION PARA EL USUARIO SUPERADMIN QUE TIENE ACCESO ABSOLUTO Y SIN RESTRICCIONES');

INSERT INTO RECURSOS_X_ROLES(ID_ROL,ID_RECURSO) VALUES((SELECT ID_ROL FROM ROLES WHERE NOMBRE_ROL = 'SUPERADMIN'), (SELECT ID_RECURSO FROM RECURSOS WHERE RECURSO = '/maestros/_masterentity/Suscriptor'));
INSERT INTO RECURSOS_X_ROLES(ID_ROL,ID_RECURSO) VALUES((SELECT ID_ROL FROM ROLES WHERE NOMBRE_ROL = 'SUPERADMIN'), (SELECT ID_RECURSO FROM RECURSOS WHERE RECURSO = '/maestros/dispositivos/_masterentity/Gateway'));
INSERT INTO RECURSOS_X_ROLES(ID_ROL,ID_RECURSO) VALUES((SELECT ID_ROL FROM ROLES WHERE NOMBRE_ROL = 'SUPERADMIN'), (SELECT ID_RECURSO FROM RECURSOS WHERE RECURSO = '/maestros/dispositivos/_masterentity/Medidor'));

INSERT INTO ROLES_X_USUARIOS(ID_USUARIO,ID_ROL) VALUES((SELECT ID_USUARIO FROM USUARIOS WHERE NOMBRE_USUARIO = 'admin123'), (SELECT ID_ROL FROM ROLES WHERE NOMBRE_ROL = 'SUPERADMIN'));
